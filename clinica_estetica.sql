...
INSERT INTO pessoa (nome_pessoa, telefone, endereco, bairro, complemento, cidade, cpf, data_nascimento, tipo, observacao, login, senha) VALUES
...
('Bruna Cardosa Brasil de Souza', STR_TO_DATE('03-10-2023', '%d-%m-%Y'), '18:00', 'Manutenção e Esmaltação em Gel', 'agendado', 2),
('Yasmin Rodrigues da Silva', STR_TO_DATE('06-10-2023', '%d-%m-%Y'), '15:00', 'Aplicação de Fibra de Vidro', 'agendado', 17),
('Ana Carolina Teixeira Reis', STR_TO_DATE('20-10-2023', '%d-%m-%Y'), '9:00', 'Massagem Relaxante', 'agendado', 1),
('Francieli Liboni Da Silva', STR_TO_DATE('20-10-2023', '%d-%m-%Y'), '16:30', 'Esmaltação em Gel', 'agendado', 7),
('Rafaela Del Rio', STR_TO_DATE('21-10-2023', '%d-%m-%Y'), '13:30', 'Maquiagem', 'agendado', 15); 
